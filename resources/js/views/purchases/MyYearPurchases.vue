        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">My Sales <span>| This Year</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{myyearpurchases.length}}</h6>
                      <span v-if="myyearpurchases.length > mylastyearpurchases.length" class="text-success small pt-1 fw-bold">{{salespercentage.toFixed(2)}}%</span>
                      <span v-if="myyearpurchases.length > mylastyearpurchases.length" class="text-muted small pt-2 ps-1">increase</span>
                      <!--decrease-->
                      <span v-if="myyearpurchases.length < mylastyearpurchases.length" class="text-danger small pt-1 fw-bold">{{salespercentage.toFixed(2)}}%</span>
                      <span v-if="myyearpurchases.length < mylastyearpurchases.length" class="text-muted small pt-2 ps-1">decrease</span>
            ...
            <h5 class="card-title">My Sales <span>| Products sold this year</span></h5>
            <p class="card-text">
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/mypurchases/'+ this.$route.params.id).then((response) => {
                ...
                this.salesdifference = this.myyearpurchases.length - this.mylastyearpurchases.length;
                this.salespercentage = 100 * (this.salesdifference/this.mylastyearpurchases.length);
