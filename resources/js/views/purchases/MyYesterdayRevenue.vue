        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">My Collected Revenue <span>| Yesterday</span></h5>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{myyesterdayprojectedrevenue.toLocaleString()}}</h6>
            ...
            <h5 class="card-title">My Collected Revenue <span>| Products sold yesterday</span></h5>
            <p class="card-text">
            ...
            <a href="#" @click="generateReport()" class="btn btn-primary" >Generate Report</a>
                ...
                <tbody>
                    <tr  v-for="product in myyesterdaypurchases" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/myrevenue/'+this.$route.params.id).then((response) => {
                ...
                this.myyesterdayprojectedrevenue = response.data.lists.myyesterdayprojectedrevenue;

                this.projecteddifference = this.myyesterdayprojectedrevenue - this.myyesterdayrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.myyesterdayrevenue);
