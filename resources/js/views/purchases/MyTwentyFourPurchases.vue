<template>
    <TheMaster>
        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
                    ...
                    <li><a @click="myTwentyFourSales()" class="dropdown-item" href="#">Last 24 Hrs</a></li>
                    <li><a @click="myYesterdaySales()" class="dropdown-item" href="#">Yesterday</a></li>
                    <li><a @click="myLastSevenSales()" class="dropdown-item" href="#">Last 7 Days</a></li>

                  </ul>
                </div>

                <div class="card-body">
                  <h5 class="card-title">My Sales <span>| Last 24 Hrs</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>{{mytwentyfourpurchases.length}}</h6>
            ...
            <h5 class="card-title">My Sales <span>| Products sold in the last 24 hrs</span></h5>
            <p class="card-text">
...
export default({
    ...
    methods: {
        myTwentyFourSales(){
            this.$router.push('/mypurchasestwentyfour/'+this.$route.params.id)
        },
        myYesterdaySales(){
            this.$router.push('/mypurchasesyesterday/'+this.$route.params.id)
        },
        myLastSevenSales(){
            this.$router.push('/mypurchaseslastseven/'+this.$route.params.id)
        },
        dateTime(value) {
