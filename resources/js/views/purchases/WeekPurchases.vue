<template>
    <TheMaster>
        ...
        <div class="row">
            ...
            <h5 class="card-title">Sales <span>| Invoices processed this week</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="invoice in weekpurchases" :key="invoice.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                this.weekpurchases = response.data.lists.weekpurchases;
                console.log("dakl",this.weekpurchases)
                setTimeout(() => {
