<template>
    <TheMaster>
        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
                    ...
                    <li>
                        <router-link to="/purchaseslastthirty" custom v-slot="{ href, navigate, isActive }">
                        <a
                            :href="href"
                            :class="{ active: isActive }"
                            class="dropdown-item"
                ...
                <div class="card-body">
                  <h5 class="card-title">Sales <span>| Last 30 Days</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{lastthirtydayspurchases.length}}</h6>
            ...
            <h5 class="card-title">Sales <span>| Products sold in the last 30 days</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="invoice in lastthirtydayspurchases" :key="invoice.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                this.lastthirtydayspurchases = response.data.lists.lastthirtydayspurchases;
                console.log("dakl",this.lastthirtydayspurchases)
                setTimeout(() => {
