        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">My Sales <span>| This Quarter</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{myquarterlypurchases.length}}</h6>
            ...
            <h5 class="card-title">My Sales <span>| Products sold this quarter</span></h5>
            <p class="card-text">
