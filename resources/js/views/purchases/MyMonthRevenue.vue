        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">My Collected Revenue <span>| This Month</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>KES. {{mymonthrevenue}}</h6>
                       <span v-if="mymonthrevenue > mylastmonthrevenue" class="text-success small pt-1 fw-bold">{{revenuepercentage}}%</span>
                        <span v-if="mymonthrevenue > mylastmonthrevenue" class="text-muted small pt-2 ps-1">increase</span>
                        <!--decrease-->
                        <span v-if="mymonthrevenue < mylastmonthrevenue" class="text-danger small pt-1 fw-bold">{{revenuepercentage}}%</span>
                        <span v-if="mymonthrevenue < mylastmonthrevenue" class="text-muted small pt-2 ps-1">decrease</span>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Projected Revenue <span>| This Month</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{mymonthprojectedrevenue.toLocaleString()}}</h6>
            ...
            <h5 class="card-title">My Collected Revenue <span>| Products sold this month</span></h5>
            <p class="card-text">
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/myrevenue/'+this.$route.params.id).then((response) => {
                this.mymonthrevenue = response.data.lists.mymonthrevenue;
                this.mymonthprojectedrevenue = response.data.lists.mymonthprojectedrevenue;
                this.mylastmonthrevenue = response.data.lists.mylastmonthrevenue;

                this.revenuedifference = this.mymonthrevenue - this.mylastmonthrevenue;
                this.revenuepercentage = 100 * (this.revenuedifference/this.mylastmonthrevenue);
                this.revenuepercentage = Number(this.revenuepercentage).toFixed(2);

                this.projecteddifference = this.mymonthprojectedrevenue - this.mymonthrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.mymonthrevenue);
