        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">My Collected Revenue <span>| Last 90 Days</span></h5>
              ...
              <div class="card info-card revenue-card">
                ...
                <!-- <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="#">lastninety</a></li>
                    <li><a class="dropdown-item" href="#">This lastninety</a></li>
                    <li><a class="dropdown-item" href="#">This Year</a></li>
                  </ul>
                </div> -->

                <div class="card-body">
                  <h5 class="card-title">Projected Revenue <span>| Last 90 Days</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{mylastninetyprojectedrevenue.toLocaleString()}}</h6>
            ...
            <h5 class="card-title">My Collected Revenue <span>| Products sold in the last 90 days</span></h5>
            <p class="card-text">
            ...
            <a href="#" @click="generateReport()" class="btn btn-primary" >Generate Report</a>
                ...
                <tbody>
                    <tr  v-for="product in mylastninetypurchases" :key="product.id" >
...
export default({
    data(){
        return {
            mylastninetypurchases: [],
            mylastninetyrevenue: [],
            mylastninetyprojectedrevenue: [],
            revenuepercentage: [],
            projectedpercentage: [],
            user: []
        }
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/myrevenue/'+this.$route.params.id).then((response) => {
                this.mylastninetyrevenue = response.data.lists.mylastninetyrevenue;
                this.mylastninetyprojectedrevenue = response.data.lists.mylastninetyprojectedrevenue;

                this.projecteddifference = this.mylastninetyprojectedrevenue - this.mylastninetyrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.mylastninetyrevenue);
        ...
        getData(){
            axios.get('/api/mypurchases/'+this.$route.params.id).then((response) => {
                this.mylastninetypurchases = response.data.lists.mylastninetypurchases;
                setTimeout(() => {
