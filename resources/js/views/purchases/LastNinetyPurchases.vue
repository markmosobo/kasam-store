        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Sales <span>| Last 90 Days</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{lastninetydayspurchases.length}}</h6>
            ...
            <h5 class="card-title">Sales <span>| Invoices processed in the last 90 days</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="invoice in lastninetydayspurchases" :key="invoice.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                this.lastninetydayspurchases = response.data.lists.lastninetydayspurchases;
                console.log("dakl",this.lastninetydayspurchases)
                setTimeout(() => {
