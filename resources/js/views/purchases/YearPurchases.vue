<template>
    <TheMaster>
        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{yearpurchases.length}}</h6>
                      <span v-if="yearpurchases.length > lastyearpurchases.length" class="text-success small pt-1 fw-bold">{{salespercentage.toFixed(2)}}%</span>
                      <span v-if="yearpurchases.length > lastyearpurchases.length" class="text-muted small pt-2 ps-1">increase</span>
                      <!--decrease-->
                      <span v-if="yearpurchases.length < lastyearpurchases.length" class="text-danger small pt-1 fw-bold">{{salespercentage.toFixed(2)}}%</span>
                      <span v-if="yearpurchases.length < lastyearpurchases.length" class="text-muted small pt-2 ps-1">decrease</span>
            ...
            <h5 class="card-title">Sales <span>| Invoices processed this year</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="invoice in yearpurchases" :key="invoice.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                this.yearpurchases = response.data.lists.yearpurchases;
                this.lastyearpurchases = response.data.lists.lastyearpurchases;
                this.salesdifference = this.yearpurchases.length - this.lastyearpurchases.length;
                this.salespercentage = 100 * (this.salesdifference/this.lastyearpurchases.length);
