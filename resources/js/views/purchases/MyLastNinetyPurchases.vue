        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">My Sales <span>| Last 90 Days</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>{{mylastninetypurchases.length}}</h6>
            ...
            <h5 class="card-title">My Sales <span>| Products sold in the last 90 days</span></h5>
            <p class="card-text">
