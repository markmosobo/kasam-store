        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Sales <span>| Last 24 Hours</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{twentyfourhourpurchases.length}}</h6>
            ...
            <h5 class="card-title">Sales <span>| Invoices processed in the last 24 hrs</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="invoice in twentyfourhourpurchases" :key="invoice.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                this.twentyfourhourpurchases = response.data.lists.twentyfourhourpurchases;
                console.log("dakl",this.twentyfourhourpurchases)
                setTimeout(() => {
