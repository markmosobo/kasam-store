        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>KES. {{myyearrevenue}}</h6>
                       <span v-if="myyearrevenue > mylastmyyearrevenue" class="text-success small pt-1 fw-bold">{{revenuepercentage}}%</span>
                        <span v-if="myyearrevenue > mylastmyyearrevenue" class="text-muted small pt-2 ps-1">increase</span>
                        <!--decrease-->
                        <span v-if="myyearrevenue < mylastmyyearrevenue" class="text-danger small pt-1 fw-bold">{{revenuepercentage}}%</span>
                        <span v-if="myyearrevenue < mylastmyyearrevenue" class="text-muted small pt-2 ps-1">decrease</span>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Projected Revenue <span>| This Year</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{myyearprojectedrevenue.toLocaleString()}}</h6>
            ...
            <h5 class="card-title">Revenue <span>| Products sold this year</span></h5>
            <p class="card-text">
            ...
            <a href="#" @click="generateReport()" class="btn btn-primary" >Generate Report</a>
                ...
                <tbody>
                    <tr  v-for="product in myyearpurchases" :key="product.id" >
      ...
      myLastYearRevenue(){
        ...
        loadLists(){
            axios.get('/api/myrevenue/'+this.$route.params.id).then((response) => {
                this.myyearrevenue = response.data.lists.myyearrevenue;
                this.myyearprojectedrevenue = response.data.lists.myyearprojectedrevenue;
                this.mylastmyyearrevenue = response.data.lists.mylastmyyearrevenue;

                this.revenuedifference = this.myyearrevenue - this.mylastmyyearrevenue;
                this.revenuepercentage = 100 * (this.revenuedifference/this.mylastmyyearrevenue);
                this.revenuepercentage = Number(this.revenuepercentage).toFixed(2);

                this.projecteddifference = this.myyearprojectedrevenue - this.myyearrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.myyearrevenue);
        ...
        getData(){
            axios.get('/api/mypurchases/'+this.$route.params.id).then((response) => {
                this.myyearpurchases = response.data.lists.myyearpurchases;
                setTimeout(() => {
