<template>
    <TheMaster>
        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>{{lastsevendayspurchases.length}}</h6>
            ...
            <h5 class="card-title">Sales <span>| Products sold in the last 7 days</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="invoice in lastsevendayspurchases" :key="invoice.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                this.lastsevendayspurchases = response.data.lists.lastsevendayspurchases;
                console.log("dakl",this.lastsevendayspurchases)
                setTimeout(() => {
