        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Collected Revenue <span>| All Time</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>KES. {{allrevenue.toLocaleString()}}</h6>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Projected Revenue <span>| All Time</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{allprojectedrevenue.toLocaleString()}}</h6>
            ...
            <h5 class="card-title">{{product.name}} Revenue <span>| All sales</span></h5>
            <p class="card-text">
            ...
            <a href="#" @click="generateReport()" class="btn btn-primary" >Generate Report</a>
                ...
                <tbody>
                    <tr  v-for="product in allsales" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/productrevenue/'+this.$route.params.id).then((response) => {
                ...
                this.projecteddifference = this.allprojectedrevenue - this.allrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.allrevenue);
            ...
            axios.get('/api/productsale/'+this.$route.params.id).then((response) => {
              this.allsales = response.data.lists.allsales;
