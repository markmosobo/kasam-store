        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Restocks <span>| This Year</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>{{yearrestocks.length}}</h6>
                       <span v-if="yearrestocks.length > lastyearrestocks.length" class="text-success small pt-1 fw-bold">{{restockpercentage}}%</span>
                      <span v-if="yearrestocks.length > lastyearrestocks.length" class="text-muted small pt-2 ps-1">increase</span>
                      <!--decrease-->
                      <span v-if="yearrestocks.length < lastyearrestocks.length" class="text-danger small pt-1 fw-bold">{{restockpercentage}}%</span>
                      <span v-if="yearrestocks.length < lastyearrestocks.length" class="text-muted small pt-2 ps-1">decrease</span>
            ...
            <h5 class="card-title">{{product.name}} Restocks <span>| Restocked this year</span></h5>
            <p class="card-text">
            ...
            <table id="saleTable" class="table table-borderless datatable">
                ...
                <tbody>
                    <tr  v-for="product in yearrestocks" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/productrestock/'+this.$route.params.id).then((response) => {
                this.yearrestocks = response.data.lists.yearrestocks;
                this.lastyearrestocks = response.data.lists.lastyearrestocks;

                this.restockdifference = this.yearrestocks.length - this.lastyearrestocks.length;
                this.restockpercentage = 100 * (this.restockdifference/this.yearrestocks.length);
