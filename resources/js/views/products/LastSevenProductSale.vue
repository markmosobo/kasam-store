        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Sales <span>| Last 7 Days</span></h5>
            ...
            <h5 class="card-title">{{product.name}} Sales <span>| Sold in the last 7 days</span></h5>
            <p class="card-text">
