        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Restocks <span>| All Time</span></h5>
            ...
            <h5 class="card-title">{{product.name}} Restocks <span>| All restocks</span></h5>
            <p class="card-text">
            ...
            <table id="saleTable" class="table table-borderless datatable">
                ...
                <tbody>
                    <tr  v-for="product in allrestocks" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/productrestock/'+this.$route.params.id).then((response) => {
                this.allrestocks = response.data.lists.allrestocks;
