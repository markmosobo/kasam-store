        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Collected Revenue <span>| Last Year</span></h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Projected Revenue <span>| Last Year</span></h5>
            ...
            <h5 class="card-title">{{product.name}} Revenue <span>| Sold last year</span></h5>
            <p class="card-text">
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/productrevenue/'+this.$route.params.id).then((response) => {
                this.lastyearrevenue = response.data.lists.lastyearrevenue;
                this.lastyearprojectedrevenue = response.data.lists.lastyearprojectedrevenue;

                this.projecteddifference = this.lastyearprojectedrevenue - this.lastyearrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.lastyearrevenue);
