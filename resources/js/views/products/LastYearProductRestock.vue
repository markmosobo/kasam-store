        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Restocks <span>| Last Year</span></h5>
            ...
            <h5 class="card-title">{{product.name}} Restocks <span>| Restocked last year</span></h5>
            <p class="card-text">
            ...
            <table id="saleTable" class="table table-borderless datatable">
                ...
                <tbody>
                    <tr  v-for="product in lastyearrestocks" :key="product.id" >
