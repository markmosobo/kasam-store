<template>
    <TheMaster>
        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
                    ...
                    <li><a @click="weekSales()" class="dropdown-item" href="#">This Week</a></li>
                    <li><a @click="lastThirtySales()" class="dropdown-item" href="#">Last 30 Days</a></li>
                  </ul>
                </div>

                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Sales <span>| Last 30 Days</span></h5>
            ...
            <h5 class="card-title">{{product.name}} Sales <span>| Sold in the last 30 days</span></h5>
            <p class="card-text">
...
export default({
    ...
    methods: {
        ...
        lastThirtySales(){
            this.$router.push('/productsalelastthirty/'+ this.$route.params.id)
        },
        getPhoto()
        {
            return "products/";
