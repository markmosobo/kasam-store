        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Collected Revenue <span>| Last Month</span></h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Projected Revenue <span>| Last Month</span></h5>
            ...
            <h5 class="card-title">{{product.name}} Revenue <span>| Sold last month</span></h5>
            <p class="card-text">
            ...
            <a href="#" @click="generateReport()" class="btn btn-primary" >Generate Report</a>
                ...
                <tbody>
                    <tr  v-for="product in lastmonthsales" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/productrevenue/'+this.$route.params.id).then((response) => {
                this.lastmonthrevenue = response.data.lists.lastmonthrevenue;
            ...
            axios.get('/api/productsale/'+this.$route.params.id).then((response) => {
              this.lastmonthsales = response.data.lists.lastmonthsales;
