        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Collected Revenue <span>| This Year</span></h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Projected Revenue <span>| This Year</span></h5>
            ...
            <h5 class="card-title">{{product.name}} Revenue <span>| Sold this year</span></h5>
            <p class="card-text">
            
            <a href="#" @click="generateReport()" class="btn btn-primary" >Generate Report</a>

            </p>
                <table id="yearRevenueTable" class="table table-borderless datatable">
                <thead>
                    <tr>
                    <!-- <th scope="col">No</th> -->
                ...
                <tbody>
                    <tr  v-for="product in yearsales" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/productrevenue/'+this.$route.params.id).then((response) => {
                this.yearrevenue = response.data.lists.yearrevenue;
                this.yearprojectedrevenue = response.data.lists.yearprojectedrevenue;

                this.projecteddifference = this.yearprojectedrevenue - this.yearrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.yearrevenue);
                this.projectedpercentage = Number(this.projectedpercentage).toFixed(2);

                setTimeout(() => {
                    $("#yearRevenueTable").DataTable();
                }, 10);
            }).catch((error) => {
        ...
        loadSales(){
            axios.get('/api/productsale/'+this.$route.params.id).then((response) => {
              this.yearsales = response.data.lists.yearsales;
