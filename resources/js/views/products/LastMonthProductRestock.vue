        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Restocks <span>| Last Month</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>{{lastmonthrestocks.length}}</h6>
            ...
            <h5 class="card-title">{{product.name}} Restocks <span>| Restocked last month</span></h5>
            <p class="card-text">
            ...
            <table id="saleTable" class="table table-borderless datatable">
                ...
                <tbody>
                    <tr  v-for="product in lastmonthrestocks" :key="product.id" >
