        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
                    ...
                    <li><a @click="yearRevenue()" class="dropdown-item" href="#">This Year</a></li>
                    <li><a @click="quarterlyRevenue()" class="dropdown-item" href="#">This Quarter</a></li>
                    <li><a @click="lastYearRevenue()" class="dropdown-item" href="#">Last Year</a></li>

                  </ul>
                </div>

                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Collected Revenue <span>| This Quarter</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>KES. {{quarterlyrevenue.toLocaleString()}}</h6>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Projected Revenue <span>| This Quarter</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{quarterlyprojectedrevenue.toLocaleString()}}</h6>
            ...
            <h5 class="card-title">{{product.name}} Revenue <span>| Sold this quarter</span></h5>
            <p class="card-text">
            ...
            <a href="#" @click="generateReport()" class="btn btn-primary" >Generate Report</a>
                ...
                <tbody>
                    <tr  v-for="product in quarterlysales" :key="product.id" >
...
export default({
    ...
    methods: {
        ...
        quarterlyRevenue(){
          this.$router.push('/productrevenuequarterly/'+ this.$route.params.id)
        },
        lastYearRevenue(){
          this.$router.push('/productrevenuelastyear/'+ this.$route.params.id)
        },
        format_date(value){
          if(value){
        ...
        loadLists(){
            axios.get('/api/productrevenue/'+this.$route.params.id).then((response) => {
                this.quarterlyrevenue = response.data.lists.quarterlyrevenue;
                this.quarterlyprojectedrevenue = response.data.lists.quarterlyprojectedrevenue;

                this.projecteddifference = this.quarterlyprojectedrevenue - this.quarterlyrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.quarterlyrevenue);
        ...
        loadSales(){
            axios.get('/api/productsale/'+this.$route.params.id).then((response) => {
              this.quarterlysales = response.data.lists.quarterlysales;
