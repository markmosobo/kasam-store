        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Collected Revenue <span>| Last 24 Hrs</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>KES. {{twentyfourrevenue.toLocaleString()}}</h6>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Projected Revenue <span>| Last 24 Hrs</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{twentyfourprojectedrevenue.toLocaleString()}}</h6>
            ...
            <h5 class="card-title">{{product.name}} Revenue <span>| Sold in the last 24 hours</span></h5>
            <p class="card-text">
            
            <a href="#" @click="generateReport()" class="btn btn-primary" >Generate Report</a>

            </p>
                <table id="twentyFourRevenueTable" class="table table-borderless datatable">
                <thead>
                    <tr>
                    <!-- <th scope="col">No</th> -->
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/productrevenue/'+this.$route.params.id).then((response) => {
                this.twentyfourrevenue = response.data.lists.twentyfourrevenue;
                this.twentyfourprojectedrevenue = response.data.lists.twentyfourprojectedrevenue;
                this.projecteddifference = this.twentyfourprojectedrevenue - this.twentyfourrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.twentyfourrevenue);
                this.projectedpercentage = Number(this.projectedpercentage).toFixed(2);

                setTimeout(() => {
                    $("#twentyFourRevenueTable").DataTable();
                }, 10);
            }).catch(() => {
