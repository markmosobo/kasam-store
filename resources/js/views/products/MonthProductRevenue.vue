        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Collected Revenue <span>| This Month</span></h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Projected Revenue <span>| This Month</span></h5>
            ...
            <h5 class="card-title">{{product.name}} Revenue <span>| Sold this month</span></h5>
            <p class="card-text">
            ...
            <a href="#" @click="generateReport()" class="btn btn-primary" >Generate Report</a>
                ...
                <tbody>
                    <tr  v-for="product in monthsales" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/productrevenue/'+this.$route.params.id).then((response) => {
                this.monthrevenue = response.data.lists.monthrevenue;
                this.monthprojectedrevenue = response.data.lists.monthprojectedrevenue;

                this.projecteddifference = this.monthprojectedrevenue - this.monthrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.monthrevenue);
            ...
            axios.get('/api/productsale/'+this.$route.params.id).then((response) => {
              this.monthsales = response.data.lists.monthsales;
