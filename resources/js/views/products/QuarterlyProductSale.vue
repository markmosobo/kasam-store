        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Sales <span>| This Quarter</span></h5>
            ...
            <h5 class="card-title">{{product.name}} Sales <span>| Sold this quarter</span></h5>
            <p class="card-text">
