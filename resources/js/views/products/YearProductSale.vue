        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Sales <span>| This Year</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>{{yearsales.length}}</h6>
                       <span v-if="yearsales.length > lastyearsales.length" class="text-success small pt-1 fw-bold">{{salespercentage}}%</span>
                       <span v-if="yearsales.length > lastyearsales.length" class="text-muted small pt-2 ps-1">increase</span>
                       <!--decrease-->
                       <span v-if="yearsales.length < lastyearsales.length" class="text-danger small pt-1 fw-bold">{{salespercentage}}%</span>
                       <span v-if="yearsales.length < lastyearsales.length" class="text-muted small pt-2 ps-1">decrease</span>
            ...
            <h5 class="card-title">{{product.name}} Sales <span>| Sold this year</span></h5>
            <p class="card-text">
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/productsale/'+this.$route.params.id).then((response) => {
                ...
                this.salesdifference = this.yearsales.length - this.lastyearsales.length;
                this.salespercentage = 100 * (this.salesdifference/this.lastyearsales.length);
