<template>
    <TheMaster>
        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
                    ...
                    <li><a @click="monthSales()" class="dropdown-item" href="#">This Month</a></li>
                    <li><a @click="lastNinetySales()" class="dropdown-item" href="#">Last 90 Days</a></li>
                  </ul>
                </div>

                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Sales <span>| This Month</span></h5>
            ...
            <h5 class="card-title">{{product.name}} Sales <span>| Sold this month</span></h5>
            <p class="card-text">
...
export default({
    ...
    methods: {
        ...
        lastNinetySales(){
            this.$router.push('/productsalelastninety/'+ this.$route.params.id)
        },
        getPhoto()
        {
            return "products/";
