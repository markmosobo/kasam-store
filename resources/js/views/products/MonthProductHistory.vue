<template>
    <TheMaster>
        ...
        <div class="row">
            ...
            <h5 class="card-title">{{product.name}}'s History <span>| Activities performed this month</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="history in monthhistory" :key="history.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/producthistory/'+this.$route.params.id).then((response) => {
                this.monthhistory = response.data.lists.monthhistory;
