<template>
    <TheMaster>
        ...
        <div class="row">
            ...
            <h5 class="card-title">{{product.name}}'s History <span>| Activities performed in the last 24 hours</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="history in twentyfourhistory" :key="history.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/producthistory/'+this.$route.params.id).then((response) => {
                this.todayhistory = response.data.lists.todayhistory;
                this.twentyfourhistory = response.data.lists.twentyfourhistory;
