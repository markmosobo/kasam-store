    ...
    <TheMaster>
        ...
        <div class="row">
            ...
            <div class="card top-selling overflow-auto">
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
                    ...
                    <li><a @click="lastMonthHistory()" class="dropdown-item" href="#">Last Month</a></li>
                    <li><a @click="lastNinetyHistory()" class="dropdown-item" href="#">Last 90 Days</a></li>
                  </ul>
                </div>
            <div class="card-body pb-0">

            <h5 class="card-title">{{product.name}}'s History <span>| Activities performed in the last 90 days</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="history in lastninetyhistory" :key="history.id" >
...
export default({
    ...
    methods: {
        ...
        lastMonthHistory(){
            this.$router.push('/producthistorylastmonth/'+ this.$route.params.id)
        },
        lastNinetyHistory(){
            this.$router.push('/producthistorylastninety/'+ this.$route.params.id)
        },
        dateTime(value) {
        ...
        loadLists(){
            axios.get('/api/producthistory/'+this.$route.params.id).then((response) => {
                this.lastninetyhistory = response.data.lists.lastninetyhistory;
