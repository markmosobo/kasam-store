        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Collected Revenue <span>| Last 7 Days</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>KES. {{lastsevenrevenue.toLocaleString()}}</h6>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Projected Revenue <span>| Last 7 Days</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{lastsevenprojectedrevenue.toLocaleString()}}</h6>
            ...
            <h5 class="card-title">{{product.name}} Revenue <span>| Sold in the last 7 days</span></h5>
            <p class="card-text">
            ...
            <a href="#" @click="generateReport()" class="btn btn-primary" >Generate Report</a>
                ...
                <tbody>
                    <tr  v-for="product in lastsevensales" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('/api/productrevenue/'+this.$route.params.id).then((response) => {
                this.lastsevenrevenue = response.data.lists.lastsevenrevenue;
                this.lastsevenprojectedrevenue = response.data.lists.lastsevenprojectedrevenue;
                this.projecteddifference = this.lastsevenprojectedrevenue - this.lastsevenrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.lastsevenrevenue);
            ...
            axios.get('/api/productsale/'+this.$route.params.id).then((response) => {
              this.lastsevensales = response.data.lists.lastsevensales;
