        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
                    ...
                    <li><a @click="weekRevenue()" class="dropdown-item" href="#">This Week</a></li>
                    <li><a @click="lastThirtyRevenue()" class="dropdown-item" href="#">Last 30 Days</a></li>

                  </ul>
                </div>

                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Collected Revenue <span>| Last 30 Days</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <!--increase-->
                       <h6>KES. {{lastthirtyrevenue.toLocaleString()}}</h6>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">{{product.name}} Projected Revenue <span>| Last 30 Days</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{lastthirtyprojectedrevenue.toLocaleString()}}</h6>
            ...
            <h5 class="card-title">{{product.name}} Revenue <span>| Sold in the last 30 days</span></h5>
            <p class="card-text">
            ...
            <a href="#" @click="generateReport()" class="btn btn-primary" >Generate Report</a>
                ...
                <tbody>
                    <tr  v-for="product in lastthirtysales" :key="product.id" >
...
export default({
    ...
    methods: {
        ...
        lastThirtyRevenue(){
          this.$router.push('/productrevenuelastthirty/'+ this.$route.params.id)
        },
        format_date(value){
          if(value){
        ...
        loadLists(){
            axios.get('/api/productrevenue/'+this.$route.params.id).then((response) => {
                this.lastthirtyrevenue = response.data.lists.lastthirtyrevenue;
                this.lastthirtyprojectedrevenue = response.data.lists.lastthirtyprojectedrevenue;

                this.projecteddifference = this.lastthirtyprojectedrevenue - this.lastthirtyrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.lastthirtyrevenue);
            ...
            axios.get('/api/productsale/'+this.$route.params.id).then((response) => {
              this.lastthirtysales = response.data.lists.lastthirtysales;
